			...
			<form action="<?php echo base_url().'homepage/search.html'?>" method="post">
				...
				<div class="col-md-8">
						<label>Category</label>
							...
							<div id="practicalAssesment1" >
								<label>Course</label>
								<select class="form-control" name="practicalAssesment">
									<option value="0">Please Select</option>
									<option value="Management Deck" <?php echo ($practicalAssesment == "Management Deck") ? 'selected="selected"' : '' ?>>Management Deck</option>
									<option value="OIC Deck" <?php echo ($practicalAssesment == "OIC Deck") ? 'selected="selected"' : '' ?>>OIC Deck</option>
									<option value="Management Engine" <?php echo ($practicalAssesment == "Management Engine") ? 'selected="selected"' : '' ?>>Management Engine</option>
									<option value="OIC Engine" <?php echo ($practicalAssesment == "OIC Engine") ? 'selected="selected"' : '' ?>>OIC Engine</option>
									<option value="RFPEW" <?php echo ($practicalAssesment == "RFPEW") ? 'selected="selected"' : '' ?>>RFPEW</option>
									<option value="RFPNW" <?php echo ($practicalAssesment == "RFPNW") ? 'selected="selected"' : '' ?>>RFPNW</option>
