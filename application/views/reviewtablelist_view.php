<script type="text/javascript">
	function confirmDelete(id){
		...
		if(x){
			...
			$.post('<?php echo base_url().'delete/reviewTableList/'?>', {id:id}, function(){
...
<div class="page-header">
	<div class="container">
		<h1 class="page-title pull-left">Review Table List</h1>
		<ol class="breadcrumb">
			<li><a href="#">Company Registration Form</a></li>
			<li class="active">Review Table List</li>
		</ol>
	</div>
</div>
<!-- END BREADCRUMBS -->
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr id="deleteId<?php echo $review->id;?>">
							...
							<td>
								<a href="<?php echo base_url().'reviewtablelist/edit/id/'.$review->id;?>" class="btn btn-warning">Edit</a>
