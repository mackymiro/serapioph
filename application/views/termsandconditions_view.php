...
<div class="page-header">
	<div class="container">
		<h1 class="page-title pull-left">Terms and Conditions</h1>
		<ol class="breadcrumb">
			<li><a href="#">Home</a></li>
...
<div class="page-content">
	<div class="container">
		<section>
			<div class="row">
				<div class="col-md-12">
					<h1 style="text-align:center;">Welcome to Serapio.ph, Inc.</h1>
					<p>
						These terms and conditions outline the rules and regulations for the use of Serapio.ph, Inc.'s Website.  
						Serapio.ph, Inc. is located at:
						Guadalupe Cebu, Cebu city Visayas - 6000, Philippines
					</p>
					<p style="text-align:justify;">
						By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Serapio.ph, Inc.'s website 
						...
						We employ the use of cookies. By using Serapio.ph, Inc.'s website you consent to the use of cookies 
						in accordance with Serapio.ph, Inc.’s privacy policy.Most of the modern day interactive web sites
						use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
						to enable the functionality of this area and ease of use for those people visiting. Some of our 
						affiliate / advertising partners may also use cookies.License
						Unless otherwise stated, Serapio.ph, Inc. and/or it’s licensors own the intellectual property rights for
						all material on Serapio.ph, Inc.. All intellectual property rights are reserved. You may view and/or print
						pages from <a href="https://www.serapio.ph">https://www.serapio.ph</a> for your own personal use subject to restrictions set in these terms and conditions.
						You must not:
					</p>
					<p>
						<ul>
							<li>Republish material from <a href="https://www.serapio.ph">https://www.serapio.ph</a></li>
							<li>Sell, rent or sub-license material from <a href="https://www.serapio.ph">https://www.serapio.ph</a></li>
							<li>Reproduce, duplicate or copy material from <a href="https://www.serapio.ph">https://www.serapio.ph</a></li>
						</ul>
					</p>
					<p>
						Redistribute content from Serapio.ph, Inc. (unless content is specifically made for redistribution).
					...
					<p>
						<ul>
							...
							<li>accounting, law and consulting firms whose primary clients are businesses; and
					...
					<p>
						...
						you must notify us by sending an e-mail to cbl@serapio.ph.
					...
					<p style="text-align:justify;">
						No use of Serapio.ph, Inc.’s logo or other artwork will be allowed for linking absent a trademark license
						agreement.
					Iframes
					...
					Serapio.ph Terms and Conditions
					</p>
					<p style="text-align:justify;">
						Credit & Contact Information<br>
