						...
						<label>Category</label>
							...
							<div id="reviewCourse1" >
								...
								<select class="form-control" name="reviewCourse">
									...
									<option value="Major Patron" <?php echo ($rCourse == "Major Patron") ? 'selected="selected"' : '' ?> >Major Patron</option>
									<option value="MDM1" <?php echo ($rCourse == "MDM1") ? 'selected="selected"' : '' ?> >MDM1</option>
									<option value="MDM2" <?php echo ($rCourse == "MDM2") ? 'selected="selected"' : '' ?> >MDM2</option>
									<option value="Boat Captain" <?php echo ($rCourse == "Boat Captain") ? 'selected="selected"' : '' ?> >Boat Captain</option>
									<option value="Motorman" <?php echo ($rCourse == "Motorman") ? 'selected="selected"' : '' ?> >Motorman</option>
								</select>
							</div>
							...
							<div id="practicalAssesment1" style="display:none;">
								<label>Course</label>
								<select class="form-control" name="practicalAssesment1">
									<option value="0">Please Select</option>
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<?php if($provinceSelected == "ALL"): ?>
							<?php foreach($getSearch2CourseProv as $search2): ?>
							<tr>
